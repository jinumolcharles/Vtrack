...
public class ViewallAdapterNew extends RecyclerView.Adapter<ViewallAdapterNew.ViewHolder> {
    ...
    public ViewallAdapterNew(Context context, ArrayList<GalleryResponse> galleryResponse,OnItemClickHelperInterface onItemClickHelperInterface) {
