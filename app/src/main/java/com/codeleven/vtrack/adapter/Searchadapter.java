...
public class Searchadapter  extends RecyclerView.Adapter<Searchadapter.ViewHolder> {
    ...
    private ArrayList<slugdatamodel> galleryResponses;
    OnItemClickHelperInterface helperInterface;

    //
    public Searchadapter(Context context, ArrayList<slugdatamodel> galleryResponse, OnItemClickHelperInterface onItemClickHelperInterface) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
         ...
         * @param data
         */
        void bindData(final slugdatamodel data) {
...
//time out also set for the requests
        ...
        private void loadImage(Response response, final slugdatamodel galleryResponse) throws IOException {
