...
public class rablogoadpter extends RecyclerView.Adapter<rablogoadpter.ViewHolder> {

    ArrayList<String> deallist;
    ArrayList<Integer> dealimage;
    Context context;

    public rablogoadpter(Context context, ArrayList<Integer> dealimage) {
        super();
...
//        this.deallist = deallist;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.custom_log0rab, viewGroup, false);
